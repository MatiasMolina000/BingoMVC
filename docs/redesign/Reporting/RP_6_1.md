...
<table style="border: 2px solid" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td>Numbers with the highest success rate.</td>
      <td><strong>Identifier:</strong></td>
      <td>RP_6_1</td>
    </tr>
    <tr>
      <td><strong>Objetive:</strong></td>
      <td colspan="3">The user will be able to view a list of the top 10 numbers with the highest participation in the completion of matches.</td>
    </tr>
    <tr>
